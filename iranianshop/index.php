...
if(isset($_SESSION['state_login']) && $_SESSION['state_login'] === true ) {
    ...
    while($row = mysqli_fetch_array($result)) {
        $counter++;
        ?>
        <td style="border-style:doted dashed;vertucal-align:top;width:33%;">
        <h4 style='color:brown;'><?php echo($row['pro_name']);?></h4>
        <a href="product_detail.php?id=<?php echo($row['pro_code'])?>">
        <img src="images/products/<?php echo($row['pro_image'])?>" width="250px" height="150px" alt="">
        </a>
...
<?php
    ...
    echo "برای نمایش محصولات باید ابتدا وارد سایت شوید";
}
?>
